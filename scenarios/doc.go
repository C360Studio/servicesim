...
// past a size-limit ingress gate, deliberate cross-provider source overlap,
// a scripted multi-turn conversation, a generic hostile-content pack (prompt
// injection, credential-shaped bait, active markup, exfiltration
// instructions and long content) exercising a consumer's guardrail on every
// dispatch path, and a provider this build has no handler for.
