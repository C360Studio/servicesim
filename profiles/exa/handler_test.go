...
func TestSearch_TruncatesToNumResultsInDeclarationOrder(t *testing.T) {
	...
	// Decoded into a local shape rather than searchResponseWire: scenario.Nullable
