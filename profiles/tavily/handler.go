...
func checkProjection(path string, p *projectionBody) []scenario.Finding {
	var findings []scenario.Finding
...
// would hide it.
func selectProjection(x *provider.Exchange, entry *scenario.ProviderEntry) (*projectionBody, bool) {
	if entry == nil {
