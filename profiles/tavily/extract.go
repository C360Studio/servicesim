...
func renderExtract(x *provider.Exchange, p *projectionBody, req *extractRequest, keys renderKeys) ([]byte, error) {
...
// AnswerProjection.ExtraFields has to its top-level projectionBody.ExtraFields.
func extractExtraFields(p *projectionBody) scenario.ExtraFields {
	if p.Extract == nil {
		return nil
	}
...
func extractFailureOverrides(x *provider.Exchange, p *projectionBody, requested []string) map[string]string {
...
func resolveExtractTarget(x *provider.Exchange, p *projectionBody, url string) (extractResolution, bool) {
...
func findProjectedResult(p *projectionBody, url string) (*resultProjection, scenario.RenderedSource, bool) {
...
func renderExtractUsage(p *projectionBody, req *extractRequest) *usageWire {
