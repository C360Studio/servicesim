...
// resultTypeEnvelope is the JSON-RPC result envelope every method's success path
...
type resultTypeEnvelope struct {
...
// profiles/tavily/errors.go, profiles/exa/errors.go), not an MCP-specific
