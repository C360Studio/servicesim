...
// profiles/exa, profiles/tavily, profiles/perplexity and profiles/mcp, each exporting Profile(). Nothing
...
// one ever does. A profile package import (profiles/exa and friends) is fine — it is what a consumer
// does.
//
